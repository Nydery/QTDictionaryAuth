...
using QTDictionaryAuth.Logic.Entities.Account;
using QTDictionaryAuth.Logic.Modules.Exceptions;
using QTDictionaryAuth.Logic.Modules.Security;
...
namespace QTDictionaryAuth.Logic.Modules.Account
{
                ...
                if (session != null && session.IsActive)
                {
                    ...
                    if (identity != null)
                    {
                        ...
                        session.JsonWebToken = JsonWebToken.GenerateToken(new Claim[]
                        {
                            ...
                            new Claim(ClaimTypes.System, nameof(QTDictionaryAuth)),
